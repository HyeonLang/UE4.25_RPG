...
| 유형 | 설명 |
|-----|-----|
| **일반 교체** | A → B 캐릭터 교체 시, A가 즉시 오프필드, B가 온필드 | ![일반교체gif](https://github.com/user-attachments/assets/7603d5be-95d7-4ea5-b61b-69ac08130309) |
| **협주 교체** | A → B 캐릭터 교체 시, A가 실행 중인 액션이 끝난 후 오프필드 | ![협주교체gif](https://github.com/user-attachments/assets/c12467b0-1b6b-4181-99e9-dd37f4de55a5) |
