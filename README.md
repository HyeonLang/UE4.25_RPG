...
## 목차 (인덱스)
0. **[멀티플레이 동기화](#1-캐릭터-교체-시스템-character-switching-system)**
...
- 변수 Replication 사용
  ...
  * 동기화 패턴이 아래와 같은 원리를 가지도록 코딩
   ![Rep](https://github.com/user-attachments/assets/1214034c-412b-4553-a0a0-36021a231090)
   ![OnRep](https://github.com/user-attachments/assets/247827ed-2b23-4356-815e-7ad97ea7862f)
